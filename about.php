      ...
      <div class="container">
        <div class="row mb-5 justify-content-center">
          <div class="col-md-7 text-center">
            ...
            <p class="lead text-white">Join the community of 5 crore satisfied job seekers....</p>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 ml-auto">
            <h2 class="section-title mb-3">Job Portal For Freelancers, Web Developers</h2>
            <p class="lead">Are you looking to create a job portal for workers? I can help guide you through the development process, including designing features like worker profiles, job listings, employer registration, search functionality, job application tracking, and an admin dashboard. Let me know your specific requirements, and I can help with technology stack choices or further development steps!</p>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 mr-auto order-md-1  mb-5 mb-lg-0">
            <h2 class="section-title mb-3">Job Portal For Workers</h2>
            <p class="lead">Are you looking to create a job portal for workers? I can help guide you through the development process, including designing features like worker profiles, job listings, employer registration, search functionality, job application tracking, and an admin dashboard. Let me know your specific requirements, and I can help with technology stack choices or further development steps!</p>
